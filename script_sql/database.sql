...
--
-- Host: 31.11.39.242:3306
-- Creato il: Set 20, 2025 alle 06:46
...
--
-- Struttura della tabella `categorie_esercizi`
--
...
CREATE TABLE `categorie_esercizi` (
  ...
  `note_categoria` varchar(255) NOT NULL
...
(2, 13, 'nomeEdu2', 'cognomeEdu2', 1, 'marchettisoft@gmail.com', '3398063701', 'inserimento edu2', 'attivo', '18/09/2025 09:39:17', 3, 14),
(6, 15, 'nomeEdu10', 'cognomeEdu10', 1, 'marchettisoft@gmail.com', '3398063701', 'test inserimento edu10', 'attivo', '19/09/2025 13:21:37', 1, 2),
(7, 17, 'sara', 'fontanella', 1, 'fontanella.s@legadelfilodoro.it', '123.4567890', 'nessuna nota', 'attivo', '19/09/2025 15:05:21', 1, 1);
...
--
-- Dump dei dati per la tabella `educatori_pazienti`
--

INSERT INTO `educatori_pazienti` (`id_associazione`, `id_educatore`, `id_paziente`, `data_associazione`, `is_attiva`, `note`) VALUES
(1, 7, 1, '19/09/2025', 1, NULL);
...
CREATE TABLE `pazienti` (
  `id_paziente` int NOT NULL,
  `id_registrazione` int NOT NULL,
  `nome_paziente` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cognome_paziente` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_sede` int DEFAULT '1',
  `id_settore` int DEFAULT NULL,
  `id_classe` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `pazienti` (`id_paziente`, `id_registrazione`, `nome_paziente`, `cognome_paziente`, `id_sede`, `id_settore`, `id_classe`) VALUES
(1, 18, 'vincenzo', 'giovane', 1, 1, 1);
...
(1, 'Fabio', 'Marchetti', 'marchettisoft@gmail.com', 'Filohori11!', 'sviluppatore', 1, '13/09/2025', '20/09/2025 08:26:29', 'attivo'),
...
(7, 'nomeAmi3', 'cognomeAmi3', 'ami3@gmail.com', 'undefined', 'amministratore', 1, '17/09/2025', NULL, 'attivo'),
(13, 'nomeEdu2', 'cognomeEdu2', 'edu2@gmail.com', 'pwdedu2', 'educatore', 1, '18/09/2025', NULL, 'attivo'),
(15, 'nomeEdu10', 'cognomeEdu10', 'edu10@gmail.com', 'pwdedu10', 'educatore', 1, '19/09/2025', NULL, 'attivo'),
(16, 'nomeAmi10', 'cognomeAmi10', 'ami10@gmail.com', 'pwdami10', 'amministratore', 1, '19/09/2025', '19/09/2025 15:08:24', 'attivo'),
(17, 'sara', 'fontanella', 'sara@gmail.com', 'pwdsara', 'educatore', 1, '19/09/2025', '19/09/2025 15:11:39', 'attivo'),
(18, 'vincenzo', 'giovane', 'vincenzo@gmail.com', 'pwdvincenzo', 'paziente', 1, '19/09/2025', NULL, 'attivo');
...
--
-- Indici per le tabelle `categorie_esercizi`
--
...
--
-- AUTO_INCREMENT per la tabella `categorie_esercizi`
--
ALTER TABLE `categorie_esercizi`
...
--
ALTER TABLE `educatori`
  MODIFY `id_educatore` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT per la tabella `educatori_pazienti`
--
ALTER TABLE `educatori_pazienti`
  MODIFY `id_associazione` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `pazienti`
--
ALTER TABLE `pazienti`
  MODIFY `id_paziente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT per la tabella `registrazioni`
--
ALTER TABLE `registrazioni`
  MODIFY `id_registrazione` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
