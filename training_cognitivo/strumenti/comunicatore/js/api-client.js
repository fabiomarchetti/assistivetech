/**
 * Client API REST per comunicazione con backend Comunicatore
 */
...
class ApiClient {
    constructor(baseUrl = null) {
        ...
        if (!baseUrl) {
            ...
            if (isLocal) {
                // MAMP locale
                this.baseUrl = '/Assistivetech/training_cognitivo/strumenti/comunicatore/api';
                console.log('📡 Ambiente: LOCALE (MAMP)');
            } else {
                // Aruba o produzione
                this.baseUrl = '/training_cognitivo/strumenti/comunicatore/api';
