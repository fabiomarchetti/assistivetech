...
### Tabelle
- \`scrivi_scrivi_parole_config\` - Configurazione esercizio
- \`scrivi_scrivi_parole_risultati\` - Risultati e punteggi
- \`scrivi_scrivi_parole_log\` - Log azioni utente
...
Upload via FTP:
\`\`\`
/training_cognitivo/scrivi/scrivi_parole/
\`\`\`
