...
### Tabelle
- \`categorizzazione_veicoli_aria_config\` - Configurazione esercizio
- \`categorizzazione_veicoli_aria_risultati\` - Risultati e punteggi
- \`categorizzazione_veicoli_aria_log\` - Log azioni utente
...
Upload via FTP:
\`\`\`
/training_cognitivo/categorizzazione/veicoli_aria/
\`\`\`
