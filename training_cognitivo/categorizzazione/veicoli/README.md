...
### Tabelle
- \`categorizzazione_veicoli_config\` - Configurazione esercizio
- \`categorizzazione_veicoli_risultati\` - Risultati e punteggi
- \`categorizzazione_veicoli_log\` - Log azioni utente
...
Upload via FTP:
\`\`\`
/training_cognitivo/categorizzazione/veicoli/
\`\`\`
