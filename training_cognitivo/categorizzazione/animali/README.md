...
### Tabelle
- \`categorizzazione_animali_config\` - Configurazione esercizio
- \`categorizzazione_animali_risultati\` - Risultati e punteggi
- \`categorizzazione_animali_log\` - Log azioni utente
...
Upload via FTP:
\`\`\`
/training_cognitivo/categorizzazione/animali/
\`\`\`
