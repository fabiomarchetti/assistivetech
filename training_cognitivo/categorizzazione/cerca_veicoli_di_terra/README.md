...
### Tabelle
- \`categorizzazione_cerca_veicoli_di_terra_config\` - Configurazione esercizio
- \`categorizzazione_cerca_veicoli_di_terra_risultati\` - Risultati e punteggi
- \`categorizzazione_cerca_veicoli_di_terra_log\` - Log azioni utente
...
Upload via FTP:
\`\`\`
/training_cognitivo/categorizzazione/cerca_veicoli_di_terra/
\`\`\`
