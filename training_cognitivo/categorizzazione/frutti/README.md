...
### Tabelle
- \`categorizzazione_frutti_config\` - Configurazione esercizio
- \`categorizzazione_frutti_risultati\` - Risultati e punteggi
- \`categorizzazione_frutti_log\` - Log azioni utente
...
Upload via FTP:
\`\`\`
/training_cognitivo/categorizzazione/frutti/
\`\`\`
