<?php
/**
 * API per gestione items del Sequenze colori
 * Endpoint: /training_cognitivo/strumenti/sequenze_colori/api/items.php
 */
    ...
    switch ($action) {
        ...
        case 'create':
            ...
            $stmt_check = $pdo->prepare("
                SELECT id_item FROM sequenze_colori_items 
            ...
            // Inserimento
            $sql = "INSERT INTO sequenze_colori_items
        ...
        case 'list':
            ...
            $sql = "SELECT * FROM sequenze_colori_items 
        ...
        case 'get':
            ...
            $stmt = $pdo->prepare("SELECT * FROM sequenze_colori_items WHERE id_item = :id");
        ...
        case 'update':
            ...
            if (isset($input['posizione_griglia'])) {
                ...
                $stmt_pag = $pdo->prepare("SELECT id_pagina FROM sequenze_colori_items WHERE id_item = :id");
            ...
            $sql = "UPDATE sequenze_colori_items SET " . implode(', ', $updates) . " WHERE id_item = :id";
            $stmt = $pdo->prepare($sql);
            $stmt->execute($params);
        ...
        case 'delete':
            ...
            // Soft delete
            $stmt = $pdo->prepare("UPDATE sequenze_colori_items SET stato = 'nascosto' WHERE id_item = :id");
            $stmt->execute([':id' => (int)$id_item]);
        ...
        case 'log':
            ...
            $sql = "INSERT INTO sequenze_colori_log 
