<?php
/**
 * API per gestione pagine del Sequenze colori
 * Endpoint: /training_cognitivo/strumenti/sequenze_colori/api/pagine.php
 */
...
try {
    ...
    switch ($action) {
        ...
        case 'create':
            ...
            $stmt_ord = $pdo->prepare("SELECT COALESCE(MAX(numero_ordine), -1) + 1 as next_ord FROM sequenze_colori_pagine WHERE id_paziente = :id_paz");
            $stmt_ord->execute([':id_paz' => $id_paziente]);
            $numero_ordine = (int)$stmt_ord->fetch(PDO::FETCH_ASSOC)['next_ord'];

            // Inserimento
            $sql = "INSERT INTO sequenze_colori_pagine
        ...
        case 'list':
            ...
            $sql = "SELECT 
                    ...
                    FROM sequenze_colori_pagine p
                    LEFT JOIN sequenze_colori_items i ON p.id_pagina = i.id_pagina AND i.stato = 'attivo'
        ...
        case 'get':
            ...
            // Dati pagina
            $stmt_pag = $pdo->prepare("SELECT * FROM sequenze_colori_pagine WHERE id_pagina = :id");
            ...
            $stmt_items = $pdo->prepare("
                SELECT * FROM sequenze_colori_items 
        ...
        case 'update':
            ...
            $sql = "UPDATE sequenze_colori_pagine SET " . implode(', ', $updates) . " WHERE id_pagina = :id";
            $stmt = $pdo->prepare($sql);
            $stmt->execute($params);
        ...
        case 'delete':
            ...
            // Soft delete
            $stmt = $pdo->prepare("UPDATE sequenze_colori_pagine SET stato = 'archiviata' WHERE id_pagina = :id");
        ...
        case 'reorder':
            ...
            $stmt = $pdo->prepare("UPDATE sequenze_colori_pagine SET numero_ordine = :ordine WHERE id_pagina = :id");
