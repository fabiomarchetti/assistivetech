...
class _HomePageState extends State<HomePage> {
  ...
  final TextEditingController _alertController = TextEditingController(text: 'Fai attenzione!!!');
  final TextEditingController _successController = TextEditingController(text: 'Molto bravo!!!');
  ...
  void _onClickableSyllableSelected(int index) {
    ...
    setState(() {
      if (selectedSyllables[0].isEmpty) {
        ...
        clickableSyllables[index] = ''; // Nasconde la sillaba selezionata
        ...
        clickableSyllables[index] = ''; // Nasconde la nuova sillaba selezionata
        imageUrl = null;
      }
    });
  }
  ...
  void _searchImage() async {
    ...
    String word = (selectedSyllables[0] + selectedSyllables[1]).toLowerCase();
  ...
  void _readWord() {
    String word = selectedSyllables[0] + selectedSyllables[1];
    if (word.isNotEmpty) {
      _speak(word);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Scrivi con le sillabe', style: TextStyle(color: Colors.white)),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Area inserimento maestra (gialla)
            Container(
              padding: const EdgeInsets.all(16),
              decoration: BoxDecoration(
              ...
              child: Column(
                children: [
                  const Text(
                    'Area Maestra - Inserisci le sillabe',
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                  ),
                  const SizedBox(height: 10),
                  Row(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Successo', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blue)),
                      TextField(
